-- Create the database if it doesn't exist (Note: PostgreSQL has different ways to create databases)
-- You can create a database manually or use the following command in the PostgreSQL shell:
-- CREATE DATABASE epic_ridge;

-- Connect to the database (Replace 'epic_ridge' with your actual database name)
\c epic_ridge;
...
CREATE TABLE IF NOT EXISTS Users (
    ...
    role VARCHAR(255) CHECK (role IN ('admin', 'student', 'parent', 'teacher')) NOT NULL,
